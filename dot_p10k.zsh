# Generated by Powerlevel10k configuration wizard on 2020-02-19 at 16:35 KST.
...
() {
  ...
  #
    # typeset -g POWERLEVEL9K_DIR_WORK_BACKGROUND='black'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|kubecolor|oc'
  ...
  typeset -g POWERLEVEL9K_WIFI_BACKGROUND='white'
  # Custom icon.
